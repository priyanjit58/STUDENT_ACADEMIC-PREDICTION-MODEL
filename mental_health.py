...
# 'diet_quality' is the only categorical feature in this subset that needs encoding.
...
print("Starting Gradient Boosting Hyperparameter Tuning on Wellness Features...")
...
print("\n" + "="*70)
print("🚀 Tuned Gradient Boosting Results (Wellness Focus):")
