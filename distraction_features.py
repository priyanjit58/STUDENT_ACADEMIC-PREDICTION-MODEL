...
# 1. 📁 Load Dataset
df = pd.read_csv("distraction_features.csv")

# 2. 🧹 Encode Categorical Features
# 'internet_quality' is the only categorical feature in this subset that needs encoding.
categorical_cols = ['internet_quality']
...
# 5. ⚙️ Feature Scaling
# Scale numerical features like social media hours, netflix hours, and screen time
...
print("Starting Gradient Boosting Hyperparameter Tuning on Distraction Features...")
...
print("\n" + "="*70)
print("🚀 Tuned Gradient Boosting Results (Distraction Focus):")
